...
const Login =() =>{
  ...
  const email   =$('<input type="email" class="username" placeholder="Correo electronico"></input>');
  const password =$('<input type="password" class="password" placeholder="Contraseña"></input>');
